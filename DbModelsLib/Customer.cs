...
namespace DbModelsLib
{
    public class Customer : ICustomer
    {
        ...
        public void OrdersAdd(Order order)
        {
            ...
            _orderValue = Orders.Sum(o => o.Value);
        }
        ...
        public int OrderCount
        {
            get
            {
                if (Orders.Count() == 0) return _orderCount;

                //update and return correct order count
                _orderCount = Orders.Count();
                return _orderCount;
            }

            set { _orderCount = value; }  //EFC usage reading from database
        }
        ...
        public decimal OrderValue
        {
            get
            {
                if (Orders.Count() == 0) return _orderValue;
            ...
            set { _orderValue = value; }  //EFC usage reading from database
        }
