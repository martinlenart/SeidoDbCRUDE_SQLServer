...
namespace DbAppConsole
{
    ...
    class Program
    {
        ...
        private static bool BuildOptions()
        {
            ...
            var connectionString = DBConnection.ConfigurationRoot.GetConnectionString("SQLServer_seidowebservice");
        ...
        private static void SeedDataBase()
        {
            using (var db = new SeidoDbContext(_optionsBuilder.Options))
            {
                ...
                for (int c = 0; c < 100; c++)
                {
                    ...
                    //Create some random orders between 0 and 10 per customer
                    for (int o = 0; o < rnd.Next(0,11); o++)
                    {
                        cus.Orders.Add(Order.Factory.CreateRandom(cus.CustomerID));
                    }
